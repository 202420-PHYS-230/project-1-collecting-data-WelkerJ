...
The goal of this project was to become famiar with all the tools we'll be using this semester in Laboratory Instrumentation and to make some real measurements, and analyze some real data. Although GitHub is a lttle confusing starting off, hopefully I will get the hang of it. In addion to that, I hope to understand Python and C better.
